...
const (
	...
	// HostValidationIDMediaPreloaded captures enum value "media-preloaded"
	HostValidationIDMediaPreloaded HostValidationID = "media-preloaded"
)
